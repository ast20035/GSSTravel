				...
				<table border="1" style="test-font: 10px" width="150%">
					...
					<tr>
						...
						<td><input type="date" name="fam_Bdate"
							class="fam_Bdate center_a" placeholder="請填寫"></td>
						...
						<td><input type="text" name="fam_Ben"
							class="fam_Ben center_a" placeholder="請填寫"></td>
						<td><input type="text" name="fam_BenRel"
							class="fam_BenRel center_a" placeholder="請填寫"></td>
						<td><input type="text" name="fam_Emg"
							class="fam_Emg center_a" placeholder="請填寫"></td>
						<td><input type="text" name="fam_EmgPhone"
							class="fam_EmgPhone center_a" placeholder="請填寫"></td>
						<td><input type="text" name="fam_EmgRel"
							class="fam_EmgRel center_a" placeholder="請填寫"></td>
						<td><input type="text" name="fam_note" class="center_a"
							placeholder="請填寫"></td>
					</tr>
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (Msg.emp_Name != null) {
					$("#select").append(
							$("<option></option>").attr("class", 'emp_name')
									.text(Msg.emp_Name));
				}
