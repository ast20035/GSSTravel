					...
					<div>
						...
						*親友為旁系三等親以上及朋友，不納入補助計算<br> <br>
						...
						<input type="button" value="新增欄位" id="insert" name="button"
							...
							name="button"> <input type="hidden" value="checkbox"
							id="checkbox" name="checkbox"> <input type="hidden"
							id="errorcount" name="errorcount">
			...
			$("#insert")
					.click(
							function(event) {
								...
								//focus在新增欄位
								$('#familytable input[name*="famname"]:last')
										.focus();
							});
							...
							function() {
								if (this.value != "") {
									if (fambenrel.test($(this).val())) {
										...
										$("#errorcount").val(0);
										setTimeout(function() {
											$("input[name*='fambenrel']").css(
													'border-color', "");
										}, 2000);
										$(this).next(".fambenrelerror")
												.text("");
