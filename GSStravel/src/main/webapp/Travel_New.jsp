	...
	<div class='container-fluid'>
		...
		<form action="<c:url value='/Travel_Edit'/>" method="GET">
			<table class="t">
				...
				<tr>
					<td>活動代碼</td>
					<td><input type="text" name="edittraNO"
						value="${params.tra_NO}" style="width: 320px"></td>
					<td></td>
				</tr>
				<tr>
...
<select class="" name ="edittraName"  m data-placeholder="請選擇" style="width: 200px;">
	...
	-->
				...
				<tr>
					<td><input type="submit" name="inputerrors" value="Insert">
						<input type="submit" name="" value="取消"></td>
				</tr>
			</table>
		</form>
