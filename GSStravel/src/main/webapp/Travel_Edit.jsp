...
<body>
	...
	<table class="t" >
		...
		<tr>
			<td>活動代碼</td>
				<td><input name="tra_no" value="${params.tra_NO}" readonly type="text"/></td> 
			<td></td>
		</tr>
		<tr>
...
<select class="" name ="edittraName"  m data-placeholder="請選擇" style="width: 200px;">
    ...
    <c:forEach var="row" items="${paramsi}">
      ...
      <li>
        ...
        <input name="dyn_val[temp_id][]" type="hidden" value="1">
         
        <select name="dyn_val[money_name][]">
        ...
        <input name="dyn_val[name][]" value="">
        <button class="add_new">+ 複製</button>
        <button class="remove_one">- 移除</button>
      </li>
      <!-- loop end -->
    </ul>
</tr>
