...
public class AnnouncementUDServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String important = request.getParameter("day");
		...
		if ("儲存".equals(save)) {
			announcementService.insert(now, title, content, important);// 新增公告
			...
			announcementService.update(now, title, content, important, time);// 修改公告
			response.sendRedirect(request.getContextPath() + "/BoardMaintain.jsp");
